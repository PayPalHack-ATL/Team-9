...
import { Auction, Auth, Bid, User } from '/models';
...
import Router from './BidPalRouter';
...
router.use('/bid', Router(Bid, 'bid', 'bids'));
router.use('/auction', Router(Auction, 'auction', 'auctions'));
